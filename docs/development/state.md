...
| Test binary (DCE)     | 261 KB    | `build/agnostik` after `CYRIUS_DCE=1 cyrius build` (was 214 KB on 5.7.12; 5.10.3 codegen differs) |
| Build warnings        | 0         |                                    |
...
See [`CHANGELOG.md`](../../CHANGELOG.md). Most recent stable: `1.0.1` (docs cleanup + toolchain refresh to Cyrius 5.10.3 on top of `1.0.0`).
