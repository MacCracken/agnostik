...
| Test binary (DCE)     | 274 KB    | `build/agnostik` after `CYRIUS_DCE=1 cyrius build` (261 KB at 1.0.1; 273 KB at 1.0.2; 1.0.3 nominal +1 KB from 5.10.14 codegen) |
| Build warnings        | 0         |                                    |
...
See [`CHANGELOG.md`](../../CHANGELOG.md). Most recent stable: `1.0.3` (toolchain refresh to Cyrius 5.10.14 + `CYRIUS_TYPE_CHECK=1` CI step + putc-workaround revert + issues archive convention).
