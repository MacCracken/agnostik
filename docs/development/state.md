...
| Module count          | 12        |                                    |
| Test files            | 8         | tests/tcyr/ (added test_audit_2026_04_26) |
| Test assertions       | 643       | 0 failed; +30 audit regressions    |
| Benchmarks            | 25        | tests/bcyr/                        |
| Test binary (DCE)     | 252 KB    | `build/agnostik` after `CYRIUS_DCE=1 cyrius build` |
