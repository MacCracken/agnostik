...
| `VERSION` | 2026-08-24 | ✅ Fresh | `1.4.0` — source of truth; `cyrius.cyml` version resolves via `${file:VERSION}`. Verified in sync with the `cyrius.cyml` pin (`6.5.35`) and the CHANGELOG header at the 1.3.6 cut. |
