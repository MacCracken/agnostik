...
| 🟡 **Stale — refresh in place** | 2 | `SECURITY.md`'s Supported Versions table (still names 1.2.x current — a support-policy call) and `CLAUDE.md`'s `cc5` mention (compiler is `cycc` since cyrius 6.0.0), both left for the maintainer at the 1.6.2 sync. |
